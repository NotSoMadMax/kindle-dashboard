...
Kindle Dashboard turns a jailbroken e-reader into an always-on information display. It presents dual-timezone clocks, local weather, and sun/moon rise-set information in an e-ink-friendly layout.

## Architecture

- A Python renderer combines time, weather, and astronomy data into grayscale dashboard images.
